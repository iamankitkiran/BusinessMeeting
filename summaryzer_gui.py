...
from file_summerizer import return_summary

# Web Scraping Pkg
from bs4 import BeautifulSoup
from urllib.request import urlopen

# to save file we use time as part of string
import time
...
def get_summary():
	...
	final_text = return_summary(raw_text)
	print(final_text)
...
button4=Button(tab1,text="Save Result", command=save_summary,width=12,bg='#03A9F4',fg='#fff')
...
b5=Button(tab2,text="Save Result", width=12,command=save_file_summary)
